...
For more information, refer to the _Official Spark Documentation_ at [https://spark.apache.org/docs/4.1.2/streaming-programming-guide.html#checkpointing](https://spark.apache.org/docs/4.1.2/streaming-programming-guide.html#checkpointing).
