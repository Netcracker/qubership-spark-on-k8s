...
- apiGroups:
  ...
  resourceNames:
  - ${Replace_with_sparkoperator_webhook_name} # Replace the name with spark operator webhook name, usually sparkoperator-spark-operator-webhook
  verbs:
  - get
  - create
  - update
...
| `spark-history-server.s3.sslInsecure`                  | false                                        | bool, null        | `~`                                                                                                                       | If set to true, sets env `JAVA_TOOL_OPTIONS` to `-Dcom.amazonaws.sdk.disableCertChecking`, meaning that there will be no certificate validation for S3.                                                                                                                                  |
