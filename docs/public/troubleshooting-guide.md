...
For more details, refer to the _Apache Spark_ official documentation at [https://spark.apache.org/docs/4.1.2/web-ui.html#streaming-dstreams-tab](https://spark.apache.org/docs/4.1.2/web-ui.html#streaming-dstreams-tab).
