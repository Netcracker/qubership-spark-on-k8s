...
{{ .Values.oauth2Proxy.image.tag | default (printf "v%s" .Chart.AppVersion) }}
{{- end -}}
...
{{- toYaml .Values.oauth2Proxy.alphaConfig.serverConfigData | nindent 2 }}
{{- end }}
{{- if .Values.oauth2Proxy.metrics.enabled }}
metricsServer:
  BindAddress: '0.0.0.0:44180'
{{- if .Values.oauth2Proxy.alphaConfig.metricsConfigData }}
{{- toYaml .Values.oauth2Proxy.alphaConfig.metricsConfigData | nindent 2 }}
{{- end }}
{{- end }}
{{- if .Values.oauth2Proxy.alphaConfig.configData }}
{{- toYaml .Values.oauth2Proxy.alphaConfig.configData | nindent 0 }}
{{- end }}
{{- if .Values.oauth2Proxy.alphaConfig.configFile }}
{{- tpl .Values.oauth2Proxy.alphaConfig.configFile $ | nindent 0 }}
{{- end }}
{{- end -}}
