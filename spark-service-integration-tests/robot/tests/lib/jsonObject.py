...
def update_app_yaml(app_image, path_to_app = '../test-app/spark-pi.yml',
                    sa_name = 'sparkoperator-spark',
                    s3_path = '', s3_a_key = '', s3_s_key = '', arguments = '50',):
...
reduced_resources = dict(requests=dict(cpu='1m', memory='1Mi'), limits=dict(cpu='1m', memory='1Mi'))
